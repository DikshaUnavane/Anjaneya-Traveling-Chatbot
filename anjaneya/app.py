...
# Load data
file_path = "D:/anjaneya/Places.csv"
...
#     # Generate a random backend key
#     backend_key = secrets.token_urlsafe(32)
#     print("BAckenkey:", backend_key)
...
flag = True
print("BOT: My name is Travel guru. Let's have a conversation. If you want to exit any time, just type Bye!")
...
while flag:
    ...
    elif user_res == "how are you":
        print("I am Anjaneya !! I have no personal thoughts or feelings, but I am designed to be informative and helpful.")
...
def generate_response(user_message):
    flag = True
    print("BOT: My name is Anjaneya. Let's have a conversation. If you want to exit any time, just type Bye!")
    api_key = 'AIzaSyDxh9mzu93K1Uxggh4ov5KOhvetlXX95DY'
    while flag:
        user_res = input("YOU: ").lower()
        greeting_response = greet(user_res)
...
#             elif any(word.lower() in user_res for word in nltk.word_tokenize(user_res)):
#                 # Generate a response using the generative model
#                 response = generate_res(user_res)
#                 print("BOT:", response)
#             else:
#                 print("BOT: I'm sorry, I couldn't identify the location for which you want weather information.")
